...
writes the survivors to `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/session/` the same way every time, so capture
...
(seed A-LIVE-023). This skill writes to `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/session/`, the count line in
`/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/README.md`, and one row at a time to `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/missed.md` —
and nothing else.
...
| **Missed** | "that should have been a seed" · "you missed X" · "why isn't X a seed?" | One row in `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/missed.md` (see Rules). No seed is written unless he also says to capture it. | `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/missed.md`, one row. |
...
3. **Write one file per seed** in `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/session/`, using the template below.
   ...
   - **No quality scores.** Facts stored; judgments computed when a decision
     needs one (`/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/README.md` rule).

4. **Update the `session/` count** in the `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/README.md` table. Nothing else
   in that file.
...
- **A miss is one row, written when it happens.** When Venkat says something
  should have been a seed, append one row to `/Users/venkatgullapalli/Documents/my-ai-lab-v2/engagement-os/seedbank/missed.md`:
