...
5. **Language that got settled.** Capture language only when something was actually
   settled, corrected, adopted, or explicitly marked worth keeping in the session. No open
   question, no generated candidates. (Venkat, 2026-09-12 02:26: "Stop the automatic
   candidate-capture step. … Capture language only when something was actually settled,
   corrected, adopted, or explicitly marked worth keeping." It replaced the 01:54 "could be
   created" part. The wording lenses were removed at 02:32: "remove the lenses. they are
   poorly applied.") Nothing to capture is the normal case. "Label" was too
